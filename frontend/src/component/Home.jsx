...
function Home() {
  ...
  /* =========================================================
     CAREER JOURNEY FEATURES
     11 FEATURES + CHATBOT = 12 FEATURES
  ========================================================= */
  ...
  return (
    <div className="home">
      ...
      <header className="navbar">
        ...
        <div className="logo">
          <img src={logo} alt="CareerXpert Logo" />
        </div>
      ...
      <section className="hero" id="home">
        ...
        <div className="hero-left">
          ...
          <p>
            Explore careers, compare professions and make
            better career decisions with CareerXpert.
          </p>

          <div className="features">
            <p>✓ 250+ Career Options</p>
            <p>✓ Personalized Career Guidance</p>
            <p>✓ Career Planning Tools</p>
            <p>✓ Learning & Career Resources</p>
          </div>

        </div>

        <div className="home-hero">
          <img src={hero} alt="Career exploration" />
        </div>
      ...
      >
        ...
        <div className="journey-heading">
          ...
          <h2>
            Your Career Journey with CareerXpert
          </h2>

          <p>
            A Complete Guide from Discovery to Growth
          </p>
      ...
      >
        ...
        <div className="about-left">
          ...
          <p>
            CareerXpert helps students discover the right
            career path based on their interests, skills and
            goals. Our platform provides career guidance,
            career planning tools, learning resources and
            complete information about different career
            opportunities.
          </p>
      ...
      <footer className="footer">
        ...
        <div className="footer-content">
          ...
          <p>
            Empowering students to explore opportunities,
            plan their careers and move towards a successful
            future.
          </p>
